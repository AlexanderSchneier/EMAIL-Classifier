...
class SVMClassifier(BaseEmailClassifier):
    ...
    def __init__(self, C: float = 1.0, max_iter: int = 10000, random_state: int = 42):
        self.C = C
        self.max_iter = max_iter
        self.random_state = random_state
        base = LinearSVC(C=C, max_iter=max_iter, random_state=random_state, dual="auto", class_weight="balanced")
